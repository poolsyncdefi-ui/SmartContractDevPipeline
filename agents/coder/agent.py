...
class CoderAgent(BaseAgent):
    """Agent spécialisé en Coder"""
    
    def __init__(self, config_path: str):
        super().__init__(config_path)
        self.specialization = "coder"
        self.sub_agents = {}
    ...
    async def execute(self, task_data: Dict[str, Any], workflow_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = await self._execute_coder(task_data, workflow_context)
    ...
    async def _execute_coder(self, task_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """Méthode spécifique à implémenter par chaque agent"""
        # À implémenter selon la spécialisation
        return {
            "message": f"Tâche exécutée par l'agent coder",
