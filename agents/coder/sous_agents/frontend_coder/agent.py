...
"""
Sous-agent Frontend Development
Spécialisation: Frontend Development
"""
from typing import Dict, Any
import yaml
import logging

class FrontendCoderSubAgent(BaseAgent):
    """Sous-agent spécialisé en Frontend Development"""
...
(self, config_path: str = ""):
        ...
        self.agent_id = f"frontend_coder_sub_01"
