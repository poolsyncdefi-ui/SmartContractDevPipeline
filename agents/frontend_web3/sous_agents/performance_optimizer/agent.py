"""
⚡ Optimisateur Performance Web3 - Sous-agent spécialisé
Version: 2.0.0

Expert en optimisation des performances Web3
"""
...
class PerformanceOptimizerSubAgent(BaseAgent):
    """
    Expert en optimisation des performances Web3
    """
    ...
    def __init__(self, config_path: str = ""):
        ...
        self._display_name = "⚡ Optimisateur Performance Web3"
    ...
    def get_agent_info(self) -> Dict[str, Any]:
        ...
        return {
            "id": self.name,
            "name": "PerformanceOptimizerSubAgent",
            "display_name": self._display_name,
            "version": "2.0.0",
