"""
🎨 Expert UI/UX Design Système - Sous-agent spécialisé
Version: 2.0.0
...
class UiUxExpertSubAgent(BaseAgent):
    ...
    def __init__(self, config_path: str = ""):
        ...
        self._display_name = "🎨 Expert UI/UX Design Système"
...
def create_ui_ux_expert_agent(config_path: str = "") -> UiUxExpertSubAgent:
    """Crée une instance du sous-agent"""
    return UiUxExpertSubAgent(config_path)
