"""
📊 Spécialiste Interfaces DeFi Avancées - Sous-agent spécialisé
Version: 2.0.0

Spécialiste des interfaces DeFi complexes (swap, lending, staking)
"""
...
class DefiUiSpecialistSubAgent(BaseAgent):
    """
    Spécialiste des interfaces DeFi complexes (swap, lending, staking)
    """
    ...
    def __init__(self, config_path: str = ""):
        ...
        self._display_name = "📊 Spécialiste Interfaces DeFi Avancées"
    ...
    async def _initialize_components(self) -> bool:
        ...
        self._components = {
            "capabilities": [
        "swap_interface_advanced",
        "lending_interface_complete",
        "staking_interface_advanced",
        "vault_interface",
        "defi_dashboard_comprehensive",
            ],
            "enabled": True,
            "version": "2.0.0"
        }
...
def create_defi_ui_specialist_agent(config_path: str = "") -> DefiUiSpecialistSubAgent:
    """Crée une instance du sous-agent"""
    return DefiUiSpecialistSubAgent(config_path)
