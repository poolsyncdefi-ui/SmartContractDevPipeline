"""
⚛️ Expert React/Next.js Avancé - Sous-agent spécialisé
Version: 2.0.0

Expert en développement React 18+, Next.js 14+, hooks personnalisés, patterns avancés et optimisation de composants
"""
...
class ReactExpertSubAgent(BaseAgent):
    """
    Expert en développement React 18+, Next.js 14+, hooks personnalisés, patterns avancés et optimisation de composants
    """
    ...
    def __init__(self, config_path: str = ""):
        ...
        self._display_name = "⚛️ Expert React/Next.js Avancé"
    ...
    async def _initialize_components(self) -> bool:
        ...
        self._components = {
            "capabilities": [
        "react_component_generation_advanced",
        "nextjs_app_router_master",
        "react_hook_generator_advanced",
        "performance_optimization_react",
        "state_management_master",
            ],
            "enabled": True,
            "version": "2.0.0"
        }
...
def create_react_expert_agent(config_path: str = "") -> ReactExpertSubAgent:
    """Crée une instance du sous-agent"""
    return ReactExpertSubAgent(config_path)
