"""
🖼️ Spécialiste Interfaces NFT Premium - Sous-agent spécialisé
Version: 2.0.0

Spécialiste des interfaces NFT (mint, gallery, marketplace)
"""
...
class NftUiSpecialistSubAgent(BaseAgent):
    """
    Spécialiste des interfaces NFT (mint, gallery, marketplace)
    """
    ...
    def __init__(self, config_path: str = ""):
        ...
        self._display_name = "🖼️ Spécialiste Interfaces NFT Premium"
...
def create_nft_ui_specialist_agent(config_path: str = "") -> NftUiSpecialistSubAgent:
    """Crée une instance du sous-agent"""
    return NftUiSpecialistSubAgent(config_path)
