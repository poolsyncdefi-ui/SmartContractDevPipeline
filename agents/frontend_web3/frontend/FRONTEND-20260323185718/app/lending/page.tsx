...
<head>
    ...
    <title>BankingWeb3 Demo Lending • Lending 2.0</title>
...
<body class="bg-[#0A0C12] text-white">
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex justify-between items-center mb-12">
            <div>
                <h1 class="text-4xl font-bold mb-2">BankingWeb3 Demo Lending</h1>
                <p class="text-gray-400">Lending & Borrowing • Cross-chain • 45.2M TVL</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div class="lending-card p-6">
                ...
                <p class="text-2xl font-bold">$28.5M</p>
                <p class="text-xs text-green-400 mt-1">+12.3%</p>
            </div>
            <div class="lending-card p-6">
