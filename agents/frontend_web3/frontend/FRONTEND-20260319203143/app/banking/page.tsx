...
<head>
    ...
    <title>BankingWeb3 Demo • Banking Web3</title>
    ...
    <style>
        ...
        * { font-family: 'Inter', sans-serif; }
        ...
        .animated-gradient {
            background: linear-gradient(45deg, #3b82f680, #10b98180, #8b5cf680);
    ...
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                        <span class="text-sm font-bold">TD</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto pt-24 px-6 pb-12">
            ...
            <div class="flex justify-between items-start mb-8">
                <div>
                    <h2 class="text-3xl font-bold">Bonjour, Thomas 👋</h2>
                    <p class="text-gray-400 mt-2">19 March 2026 • Dernière connexion il y a 2 min</p>
                </div>
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <div class="flex items-end space-x-2">
                                <span class="text-4xl font-bold">$45,890</span>
                                <span class="text-sm text-green-400 mb-1">+2.4%</span>
                            </div>
                            <div class="flex items-center mt-4 space-x-4">
                                <span class="text-xs text-gray-400">≈ 12.5 ETH</span>
                                <span class="text-xs text-gray-400">• ≈ 0.45 BTC</span>
                            </div>
                        </div>
