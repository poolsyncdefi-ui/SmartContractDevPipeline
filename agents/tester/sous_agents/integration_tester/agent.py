...
"""
Sous-agent Integration Testing
Spécialisation: Integration Testing
"""
from typing import Dict, Any
import yaml
import logging

class IntegrationTesterSubAgent(BaseAgent):
    """Sous-agent spécialisé en Integration Testing"""
...
(self, config_path: str = ""):
        ...
        self.agent_id = f"integration_tester_sub_01"
