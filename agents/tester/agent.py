...
class TesterAgent(BaseAgent):
    """Agent spécialisé en Tester"""
    
    def __init__(self, config_path: str):
        super().__init__(config_path)
        self.specialization = "tester"
        self.sub_agents = {}
    ...
    async def execute(self, task_data: Dict[str, Any], workflow_context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = await self._execute_tester(task_data, workflow_context)
    ...
    async def _execute_tester(self, task_data: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        """Méthode spécifique à implémenter par chaque agent"""
        # À implémenter selon la spécialisation
        return {
            "message": f"Tâche exécutée par l'agent tester",
